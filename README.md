...
| [01.4-sdes-euler-milstein.ipynb](notebooks/01-procesos-estocasticos/01.4-sdes-euler-milstein.ipynb) | SDEs: GBM, OU, CIR — soluciones exactas, Euler-Maruyama, Milstein, convergencia fuerte/débil | — |
| [01.5-girsanov-change-of-numeraire.ipynb](notebooks/01-procesos-estocasticos/01.5-girsanov-change-of-numeraire.ipynb) | Girsanov y cambio de numerario | — |
...
| [02.2-binomial-crr.ipynb](notebooks/02-tiempo-discreto/02.2-binomial-crr.ipynb) | Binomial multi-periodo (CRR): europeas y americanas | — |
| [02.3-fundamental-theorems-asset-pricing.ipynb](notebooks/02-tiempo-discreto/02.3-fundamental-theorems-asset-pricing.ipynb) | Teoremas fundamentales del asset pricing | — |
...
| Notebook | Tema | Estado |
|---|---|---|
| [03.1-black-scholes-derivation.ipynb](notebooks/03-tiempo-continuo/03.1-black-scholes-derivation.ipynb) | Black-Scholes: derivación por réplica (PDE) y por martingalas | — |
